...
const RequestCookie: React.FunctionComponent = () => {
  const dispatch = useAppDispatch()
  const { params } = useAppSelector((state) => ({
    params: state.document.apiData.apiInfo.request.cookie,
  }))
...
export default memo(RequestCookie)
