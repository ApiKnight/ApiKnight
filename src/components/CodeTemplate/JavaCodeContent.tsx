        ...
        <div className='codeTemplate-content__codeBlock'>
                    {
                        ...
                        current === '1' ? (
                            <code>
                                {
                                    createUnirestTemplate('http://127.0.0.1/xxx',"GET","'User-Agent': 'Apifox/1.0.0 (https://apifox.com)'",'follow')
                                }
                            </code>
                        ) : (
                            <code>
                                {
                                    createOkHttpTemplate('http://127.0.0.1/xxx',"GET","'User-Agent': 'Apifox/1.0.0 (https://apifox.com)'")
                                }
                            </code>
                        )
                    }
